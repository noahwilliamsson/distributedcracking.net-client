...
inc_key_loop_state inc_rec_state = {
	...
	0,				// words req
	0,				// words actually generated
	""				// key_i
};


int webapi_inc_get_progress() {
	if(inc_rec_state.words_requested == 0)
		return 0;
	
	return (int) ((double)100.0 * inc_rec_state.words_generated / inc_rec_state.words_requested); 
}
#endif
